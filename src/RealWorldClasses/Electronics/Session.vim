...
nnoremap \dd :Lexplore %:p:h
nnoremap \da :Lexplore
...
silent only
silent tabonly
cd /run/media/scion/4b29c2d1-0afc-4483-9ae7-029e32ec28b8/repos/RealWorldClasses/src
...
badd +1 RealWorldClasses/Electronics/nPnTransistor.cs
badd +224 ~/.vimrc
argglobal
%argdel
$argadd RealWorldClasses/Electronics/nPnTransistor.cs
set stal=2
tabnew +setlocal\ bufhidden=wipe
tabrewind
edit RealWorldClasses/Electronics/nPnTransistor.cs
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 104 + 66) / 132)
exe 'vert 2resize ' . ((&columns * 27 + 66) / 132)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
wincmd w
argglobal
if bufexists(fnamemodify("RealWorldClasses/Electronics", ":p")) | buffer RealWorldClasses/Electronics | else | edit RealWorldClasses/Electronics | endif
balt RealWorldClasses/Electronics/nPnTransistor.cs
let s:cpo_save=&cpo
set cpo&vim
...
keepjumps 1
normal! 0
lcd /run/media/scion/4b29c2d1-0afc-4483-9ae7-029e32ec28b8/repos/RealWorldClasses/src/RealWorldClasses/Electronics
wincmd w
2wincmd w
exe 'vert 1resize ' . ((&columns * 104 + 66) / 132)
exe 'vert 2resize ' . ((&columns * 27 + 66) / 132)
...
edit ~/.vimrc
argglobal
balt /run/media/scion/4b29c2d1-0afc-4483-9ae7-029e32ec28b8/repos/RealWorldClasses/src/RealWorldClasses/Electronics/nPnTransistor.cs
...
setlocal spelllang=en
setlocal spelloptions=
setlocal statusline=%{lightline#link()}%#LightlineLeft_active_0#%(\ %{lightline#mode()}\ %)%{(&paste)?\"|\":\"\"}%(\ %{&paste?\"PASTE\":\"\"}\ %)%#LightlineLeft_active_0_1#%#LightlineLeft_active_1#%(\ %R\ %)%{(&readonly)&&(1||(&modified||!&modifiable))?\"|\":\"\"}%(\ %t\ %)%{(&modified||!&modifiable)?\"|\":\"\"}%(\ %M\ %)%#LightlineLeft_active_1_2#%#LightlineMiddle_active#%=%#LightlineRight_active_3_4#%#LightlineRight_active_3#%(\ %{&ff}\ %)%{1||1||1?\"|\":\"\"}%(\ %{&fenc!=#\"\"?&fenc:&enc}\ %)%{1||1?\"|\":\"\"}%(\ %{&ft!=#\"\"?&ft:\"no\ ft\"}\ %)%{1?\"|\":\"\"}%(\ %{sharpenup#statusline#StatusText(0)}%{sharpenup#statusline#StatusText(1)}%{sharpenup#statusline#StatusText(2)}\ %)%#LightlineRight_active_2_3#%#LightlineRight_active_2#%(\ %3p%%\ %)%#LightlineRight_active_1_2#%#LightlineRight_active_1#%(\ %3l:%-2c\ %)%#LightlineRight_active_right_1#%#LightlineRight_active_right#%(\ ï€Œ\ \ %)
setlocal suffixesadd=
setlocal swapfile
setlocal synmaxcol=3000
if &syntax != 'vim'
...
silent! normal! zE
let &fdl = &fdl
let s:l = 226 - ((74 * winheight(0) + 49) / 98)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 226
